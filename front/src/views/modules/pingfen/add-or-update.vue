    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="评分" prop="pingfenPingfen">
                       <el-input v-model="ruleForm.pingfenPingfen"
                                 placeholder="评分" clearable  :readonly="ro.pingfenPingfen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="评分" prop="pingfenPingfen">
                           <el-input v-model="ruleForm.pingfenPingfen"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="pingfenText">
                        <el-input type="textarea"  :readonly="ro.pingfenText" v-model="ruleForm.pingfenText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.pingfenText" label="评价内容" prop="pingfenText">
                            <span v-html="ruleForm.pingfenText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
