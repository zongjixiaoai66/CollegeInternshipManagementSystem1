      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '公司名称' : ''">
            <el-input prefix-icon="el-icon-search" v-model="searchForm.gongsiName" placeholder="公司名称"
                      clearable></el-input>
          </el-form-item>
        ...
        <el-row class="ad"
          ...
          <el-form-item>
            ...
            <a style="text-decoration:none" class="el-button el-button--success"
               ...
               href="http://localhost:8080/gaoxiaoxueshengshixiguanlixitong/upload/pingfenMuBan.xls"
            >批量导入实习评分数据模板</a>
            &nbsp;
            <el-upload
                v-if="isAuth('pingfen','导入导出')"
            ...
            &nbsp;
            <!-- 导出excel -->
            <download-excel v-if="isAuth('pingfen','导入导出')" style="display: inline-block"
                            class="export-excel-wrapper" :data="dataList" :fields="json_fields" name="pingfen.xls">
              <!-- 导出excel -->
              <el-button
                  type="success"
                  icon="el-icon-download"
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                           ...
                           label="评价内容">
            <template slot-scope="scope">
                            <span v-if="scope.row.pingfenText != null &&scope.row.pingfenText.length>10">
                                {{ scope.row.pingfenText.slice(0, 10) }}...
                            </span>
              <span v-else>
                                {{ scope.row.pingfenText }}
                            </span>
            </template>
          </el-table-column>
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('pingfen','查看')" type="success" icon="el-icon-tickets" size="mini"
                         @click="addOrUpdateHandler(scope.row.id,'info')">详情
              </el-button>
              <el-button v-if="isAuth('pingfen','修改')" type="primary" icon="el-icon-edit" size="mini"
                         @click="addOrUpdateHandler(scope.row.id)">修改
              </el-button>
              <el-button v-if="isAuth('pingfen','删除')" type="danger" icon="el-icon-delete" size="mini"
    ...
    chartDialog() {
      ...
      let params = {
        ...
        thisTable: {//当前表
          ...
          string: 'pingfen_pingfen',//分组字符串字段
