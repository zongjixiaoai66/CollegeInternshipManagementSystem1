    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="实习情况" prop="qingkuangText">
                        <el-input type="textarea"  :readonly="ro.qingkuangText" v-model="ruleForm.qingkuangText" placeholder="实习情况"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.qingkuangText" label="实习情况" prop="qingkuangText">
                            <span v-html="ruleForm.qingkuangText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 提交
            onSubmit() {
              this.ruleForm.yonghuId=this.userId
                this.$refs["ruleForm"].validate(valid => {

                    if (valid) {
                        this.$http({
                            url:`qingkuang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.qingkuangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
