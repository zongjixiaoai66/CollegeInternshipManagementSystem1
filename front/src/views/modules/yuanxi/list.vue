                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gaoxiaoxueshengshixiguanlixitong/upload/yuanxiMuBan.xls"
                        >批量导入院系数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yuanxi','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="yuanxiUuidNumber"
                                   header-align="center"
                                   label="院系编号">
                        <template slot-scope="scope">
                            {{scope.row.yuanxiUuidNumber}}
                        </template>
                    </el-table-column>
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'yuanxi',//当前表表名,
                        sumColum : 'yuanxi_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'yuanxi_name',//分组字符串字段
                        // types : 'yuanxi_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
