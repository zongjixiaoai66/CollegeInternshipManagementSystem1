<template>
	<div class="addEdit-block">
		<el-form label-position="top" class="detail-form-content" ref="ruleForm" :model="ruleForm" :rules="rules"
			...
			<el-form-item class="input" label="进入数据库所需要的学生名" prop="userName">
				<el-input clearable placeholder="进入数据库所需要的学生名" v-model="ruleForm.userName"></el-input>
			</el-form-item>
