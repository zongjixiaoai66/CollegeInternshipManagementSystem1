            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yuanxi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="院系编号" prop="yuanxiUuidNumber">
                        <el-input v-model="yuanxiForm.yuanxiUuidNumber"
                                  placeholder="院系编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='yuanxi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="院系位置" prop="yuanxiAddress">
                        <el-input v-model="yuanxiForm.yuanxiAddress"
                                  placeholder="院系位置" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
