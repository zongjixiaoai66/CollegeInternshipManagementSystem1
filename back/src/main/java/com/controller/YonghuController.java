    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            //级联表 院系
            //级联表
            YuanxiEntity yuanxi = yuanxiService.selectById(yonghu.getYuanxiId());
            if(yuanxi != null){
            BeanUtils.copyProperties( yuanxi , view ,new String[]{ "id", "createTime", "insertTime", "updateTime"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            if(banji != null){
            BeanUtils.copyProperties( banji , view ,new String[]{ "id", "createTime", "insertTime", "updateTime"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
...
//                            yonghuEntity.setYuanxiId(Integer.valueOf(data.get(0)));   //院系 要改的
//                            yonghuEntity.setBanjiId(Integer.valueOf(data.get(0)));   //班级 要改的
